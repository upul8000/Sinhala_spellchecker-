...
class SinhalaSpellChecker {
    constructor() {
        ...
        this.prefixes = [
            'අප', 'අනු',  'අව', 'අ', 'ආ', 'අන්', 'අධි', 'අදි', 'අපි', 'අති', 'අභි', 'අබි',
            'ප්‍ර', 'ප', 'පරා', 'පර', 'ප්‍රති', 'පටි', 'පිළි', 'පස්', 'පිහි', 'පරි', 'පිරි',
            'සම්', 'සං', 'ස', 'සන්', 'සහ', 'සත්', 'සද්', 'සු', 'සිව්', 
            'නිස්', 'නිශ්', 'නිෂ්', 'නිර්', 'නි', 'නී', 'නු', 'නූ', 'නෙ', 'නේ', 'න', 'නා', 'නො', 'නිරා', 'නිශා', 
            'උද්', 'උත්', 'උන්', 'උ', 'උප', 'උව',
            'තාව', 'තත්', 'තුන්', 'තෙ', 
            'දුශ්', 'දුර්', 'දුෂ්', 'දුස්', 'දෙ', 'දු', 'දුඃ', 
            'බිම්', 'මිහි', 'බහු',
            'යාව', 'යථා',
            'විශ්ව', 'වි',  
            'ලුහු',
        ...
        this.suffixesToStrip = [
            ...
            'ම', 'ම්', 'මි', 'මු', 'මුවා', 'මය', 'මත්', 'මෙහි',  
            'ක', 'කු',  'ක්', 'කි', 'කරු', 'කාර', 'කාරී', 'කට', 'කාමී', 'කින්',
            'ය', 'යා', 'යේ', 'යෝ', 'යෙන්', 'යෙහි', 
            'යන්', 'යන්හි', 'යකු', 'යෙකු', 'යෙක්', 'යක්','යෙකි', 
            'ගේ', 'ගෙන්', 'ගෙන',  'ගුලු',
